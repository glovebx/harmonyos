...
package com.huawei.codelab616.map;

import com.huawei.codelab616.IMapIdlInterface;
import com.huawei.codelab616.MapIdlInterfaceStub;
import com.huawei.codelab616.WatchAbility;
import com.huawei.codelab616.WatchService;
...
public class MapManager {
    ...
    private void connectWatchService(String deviceId) {
        ...
        boolean result = slice.connectAbility(intent, conn);

        LogUtils.info(TAG, "connectAbility result:" + result);
    }
